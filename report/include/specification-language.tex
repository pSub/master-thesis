...
of the target language. \todo{Refer to that section} 
...
meta-variable declarations when resolving imports. For details
see Section~\ref{sec:generate-sdf}.
...
language, to reduce the chance of encountering ambiguities.
...
\todo{Explain the other two typing rules}
...
\todo{Those two paragraphs need more separation}
