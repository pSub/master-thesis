...
\code[breaklines=true]|specifications/simply-typed-lambda-calculus/syntax.sdf|
...
\code|BaseLanguage|, which is parameterized by the non-terminals
\code|TypingJudgment| and \code|MetaVariable|. Those non-terminals
