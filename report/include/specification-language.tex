...
copies a dummy \verb|Generated| module from the resource folder into
the syntax folder. This module contains empty productions for the
non-terminals \verb|TypingJudgment| and \verb|MetaVariable| and
ensures that a compilation of the whole project is possible, without a
specification (e.g.\ to run tests). The strategy \verb|toSdf|
generates a specification specific \verb|Generated| module. 
