...
The rule \verb|generate'| now evaluates the selected template
...
\todo{Cite}. In the rule \verb|~T| occurs free in the second
...
In the case \verb|generate'| encounters a fork it evaluates all
templates contained in the fork using \verb|generate'|. It tries to
