...
public class SLTCParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SLTC");
  ...
  { 
    SLTCParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SLTCParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SLTCParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SLTCParseControllerGenerated.class);
    }
  ...
  { 
    return SLTCParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
